...
[![Coverage Status](https://img.shields.io/codecov/c/github/gzt/teatimer/master.svg)](https://codecov.io/github/gzt/teatimer?branch=master) 
...
By default, it plays the 'ping' sound. To play a random sound, set `sound = 1`.
